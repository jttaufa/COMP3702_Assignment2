...
public class Tour {
	...
	public boolean buyCycle(Cycle cycle) {
		if (raceNo != 0 || status != Status.PREPARING) {
			System.out
					.println("You can only buy cycles at the start of the tour");
			return false;
	 ...
	 * the current amount of money > the track's registration fee, and the track
	 * has not been raced on before
	 * 
	 * @return
	 */
	 ...
	 * 
	 * @param track
	 *            The chosen track. Must be in getAvailableTracks()
	 * @param players
